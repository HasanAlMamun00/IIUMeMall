...
const CafeDetails = () => {
  ...
  return (
    <>
      <h2 className="text-[#062A70] text-[24px] font-semibold mb-8">
        cafe {menuItems?.data?.userData?.name ? menuItems?.data?.userData?.name : menuItems?.data?.userData?.email}
      </h2>
        ...
        <div className="col-span-4 py-5 flex justify-center">
          <div>
            <h2 className="text-[#016170] text-[42px] font-bold capitalize">
              {menuItems?.data?.itemdata?.name}
            </h2>
            <p className="text-gray-500 font-bold text-[22px] mt-3 text-end">
